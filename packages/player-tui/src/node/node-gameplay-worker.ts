...
import { autoPlay, manualPlay, PlayerInterruptedError } from '@be-music/player/core/engine';
import type { PlayerLoadProgress } from '@be-music/player/core/engine';
...
function serializeUiRuntimeInit(context: CreatePlayerUiRuntimeContext): NodeGameplayUiRuntimeInit {
  return {
    ...
    kittyGraphics: Boolean(initData.playOptions.kittyGraphics),
