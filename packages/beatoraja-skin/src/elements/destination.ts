...
function resolveKeyframeAlternative(
  ...
  for (const alt of alternatives) {
    ...
    const value =
      typeof obj.value === 'object' && obj.value !== null ? (obj.value as Readonly<Record<string, unknown>>) : obj;
    lastValid = value;
 ...
 */
function applyKeyframeFields(obj: Readonly<Record<string, unknown>>, state: BeatorajaDestinationKeyframe): void {
